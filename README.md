...
<script type="text/javascript" src="https://unpkg.com/highlightjs-odinlang@1.1.0/dist/odin.min.js"></script>
```
...
import hljsOdin from 'https://unpkg.com/highlightjs-odinlang@1.1.0/dist/odin.es.min.js';
